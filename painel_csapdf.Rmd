---
title: "Painel de CSAP do Distrito Federal "
logo: "LOGO_SIMBOLO_VAZADA_SDS.png"
output: 
...
---
```{r, include=F, echo=F, message=FALSE, warning=FALSE}
#####Preparo ----
...
ggplot(aes(x=Prop, y=mes, fill=RA, label = round(Prop,1)))+
  ...
  scale_fill_manual(values=c("#00FFFF", "#00CED1", "#40E0D0", "#20B2AA", "#008080", "#5F9EA0", "#66CDAA", "#7FFFD4"),
                    name = "")+
  coord_flip()+
  ggsave(paste0("Figuras/Prop_",rs,"_MesRA.png"), width=350, height=200, units="mm")
}
...
<p style="font-size:11px"><b>Internações por Condições Sensíveis à APS (ICSAP)</b></p>  
<p style="font-size:10px">As Internações por Condições Sensíveis à Atenção Primária à Saúde (ICSAP) são internações por causas evitáveis, preveníveis a partir de uma Atenção Primária à Saúde (APS) de qualidade e oportuna.</p>

<p style="font-size:10px">Indicadores de ICSAP têm sido usados nacional e internacionalmente como parâmetro de avaliação de desempenho da APS. Isso quer dizer que por meio dos indicadores de ICSAP, de nível hospitalar, é possível qualificar a assistência prestada e promover melhorias constantes.</p>

<p style="font-size:10px">O Brasil possui a Lista Brasileira de Condições Sensíveis à Atenção Primária, instituída e reconhecida pela Portaria nº 221 de 21 de abril de 2008, do Ministério da Saúde, em que constam 19 grupos de causas pela CID-10 de importância nacional.</p>
_ _ _ _ _ 

<p style="font-size:11px"><b>Sobre o painel</b></p>
<p style="font-size:10px">O painel apresenta indicadores de internações por CSAP de residentes do Distrito Federal no ano de 2020. A partir da barra de navegação superior, é possível visulizar os indicadores de uma visão geral do DF ou por Região de Saúde.</p>

<p style="font-size:10px">Estão disponíveis indicadores de proporção de internações por CSAP por tipo de internação, Região de Saúde, Região Administrativa, sexo, faixa etária e mês.</p>

<p style="font-size:10px">Os dados relativos às internações são de origem do Sistema de Informações Hospitalares (SIH) e CEP Aberto.</p>

<p style="font-size:9px">As faixas etárias referem-se a:  
Jovem: 0 a 19 anos  
Adulto: 20 a 49 anos  
Idoso: 50 a 80+ anos</p>

_ _ _ _ _ 

<p style="font-size:9px">Data de atualização: 13/07/2021</p>

_ _ _ _

<p style="font-size:9px"><b>Dúvidas? Sugestões?</b>  
Sala de Situação FS/UnB    
<sds@unb.br>  
<https://sds.unb.br/></p>
```{r, include=F}
library(fontawesome)
...
### Proporção de internações de residentes no DF, por tipo de causa, DF, 2020
![cálculo: internações por CSAP em 2020/total de internações em 2020 x 100](Figuras/Prop_DF.png)

### Proporção de internações por CSAP, de residentes no DF, por mês, DF, 2020
![cálculo: internações por CSAP por mês em 2020/total de internações por mês em 2020 x 100](Figuras/Prop_DF_Mes.png)


### Proporção de internações de residentes no DF, por grupo de CSAP, DF, 2020
![cálculo: internações por grupo CSAP em 2020/total de internações em 2020 x 100](Figuras/Prop_Grupo.png)

### Proporção de internações de residentes no DF, por tipo de causa e Região de Saúde, DF, 2020
![cálculo: internações por mês em 2020/total de internações por mês em 2020 x 100](Figuras/Prop_DF_RS.png)
...
{data-width=250}
-----------------------------------------------------------------------
### Proporção de internações por CSAP, de residentes, Região Administrativa, DF, 2020
![cálculo: internações por CSAP por RA em 2020/total de internações por RA em 2020 x 100](Figuras/Prop_Sul_RA.png)


### Proporção de internações por CSAP, de residentes, por mês e Região Administrativa, DF, 2020
![cálculo: internações por CSAP por mês de 2020/total de internações por mês de 2020 x 100](Figuras/Prop_Sul_MesRA.png)

### Proporção de internações por CSAP, de residentes, por faixa etária\* e Região Administrativa, DF, 2020
![cálculo: internações por CSAP em 2020 por faixa etária/total de internações por CSAP em 2020 x 100](Figuras/Prop_Sul_FaixaRA.png) 

### Proporção de internações por CSAP, de residentes, por sexo e Região Administrativa, DF, 2020 
![cálculo: internações por CSAP, por sexo, em 2020/total de internações por CSAP em 2020 x 100](Figuras/Prop_Sul_SexoRA.png) 

### Proporção de internações de residentes, por grupo e Região Administrativa, 2020
![cálculo: internações por grupo CSAP em 2020/total de internações por grupo CSAP em 2020 x 100](Figuras/Prop_Sul_GrupoRA.png) 
...
### Proporção de internações por CSAP, de residentes, Região Administrativa, DF, 2020
![cálculo: internações por CSAP por RA em 2020/total de internações por RA em 2020 x 100](Figuras/Prop_Norte_RA.png)

### Proporção de internações por CSAP, de residentes, por mês e Região Administrativa, DF, 2020
![cálculo: internações por CSAP por mês de 2020/total de internações por mês de 2020 x 100](Figuras/Prop_Norte_MesRA.png)

### Proporção de internações por CSAP, de residentes, por faixa etária\* e Região Administrativa, DF, 2020
![cálculo: internações por CSAP em 2020 por faixa etária/total de internações por CSAP em 2020 x 100](Figuras/Prop_Norte_FaixaRA.png) 

### Proporção de internações por CSAP, de residentes, por sexo e Região Administrativa, DF, 2020 
![cálculo: internações por CSAP, por sexo, em 2020/total de internações por CSAP em 2020 x 100](Figuras/Prop_Norte_SexoRA.png) 

### Proporção de internações de residentes, por grupo e Região Administrativa, 2020
![cálculo: internações por grupo CSAP em 2020/total de internações por grupo CSAP em 2020 x 100](Figuras/Prop_Norte_GrupoRA.png) 
...
-----------------------------------------------------------------------
### Proporção de internações por CSAP, de residentes, Região Administrativa, DF, 2020
![cálculo: internações por CSAP por RA em 2020/total de internações por RA em 2020 x 100](Figuras/Prop_Leste_RA.png)

### Proporção de internações por CSAP, de residentes, por mês e Região Administrativa, DF, 2020
![cálculo: internações por CSAP por mês de 2020/total de internações por mês de 2020 x 100](Figuras/Prop_Leste_MesRA.png)

### Proporção de internações por CSAP, de residentes, por faixa etária\* e Região Administrativa, DF, 2020
![cálculo: internações por CSAP em 2020 por faixa etária/total de internações por CSAP em 2020 x 100](Figuras/Prop_Leste_FaixaRA.png) 

### Proporção de internações por CSAP, de residentes, por sexo e Região Administrativa, DF, 2020 
![cálculo: internações por CSAP, por sexo, em 2020/total de internações por CSAP em 2020 x 100](Figuras/Prop_Leste_SexoRA.png) 

### Proporção de internações de residentes, por grupo e Região Administrativa, 2020
![cálculo: internações por grupo CSAP em 2020/total de internações por grupo CSAP em 2020 x 100](Figuras/Prop_Leste_GrupoRA.png) 
...
-----------------------------------------------------------------------
### Proporção de internações por CSAP, de residentes, Região Administrativa, DF, 2020
![cálculo: internações por CSAP por RA em 2020/total de internações por RA em 2020 x 100](Figuras/Prop_Oeste_RA.png)


### Proporção de internações por CSAP, de residentes, por mês e Região Administrativa, DF, 2020
![cálculo: internações por CSAP por mês de 2020/total de internações por mês de 2020 x 100](Figuras/Prop_Oeste_MesRA.png)

### Proporção de internações por CSAP, de residentes, por faixa etária\* e Região Administrativa, DF, 2020
![cálculo: internações por CSAP em 2020 por faixa etária/total de internações por CSAP em 2020 x 100](Figuras/Prop_Oeste_FaixaRA.png) 

### Proporção de internações por CSAP, de residentes, por sexo e Região Administrativa, DF, 2020 
![cálculo: internações por CSAP, por sexo, em 2020/total de internações por CSAP em 2020 x 100](Figuras/Prop_Oeste_SexoRA.png) 

### Proporção de internações de residentes, por grupo e Região Administrativa, 2020
![cálculo: internações por grupo CSAP em 2020/total de internações por grupo CSAP em 2020 x 100](Figuras/Prop_Oeste_GrupoRA.png) 
...
-----------------------------------------------------------------------
### Proporção de internações por CSAP, de residentes, Região Administrativa, DF, 2020
![cálculo: internações por CSAP por RA em 2020/total de internações por RA em 2020 x 100](Figuras/Prop_Central_RA.png)


### Proporção de internações por CSAP, de residentes, por mês e Região Administrativa, DF, 2020
![cálculo: internações por CSAP por mês de 2020/total de internações por mês de 2020 x 100](Figuras/Prop_Central_MesRA.png)

### Proporção de internações por CSAP, de residentes, por faixa etária\* e Região Administrativa, DF, 2020
![cálculo: internações por CSAP em 2020 por faixa etária/total de internações por CSAP em 2020 x 100](Figuras/Prop_Central_FaixaRA.png) 

### Proporção de internações por CSAP, de residentes, por sexo e Região Administrativa, DF, 2020 
![cálculo: internações por CSAP, por sexo, em 2020/total de internações por CSAP em 2020 x 100](Figuras/Prop_Central_SexoRA.png) 

### Proporção de internações de residentes, por grupo e Região Administrativa, 2020
![cálculo: internações por grupo CSAP em 2020/total de internações por grupo CSAP em 2020 x 100](Figuras/Prop_Central_GrupoRA.png) 
...
-----------------------------------------------------------------------
### Proporção de internações por CSAP, de residentes, Região Administrativa, DF, 2020
![cálculo: internações por CSAP por RA em 2020/total de internações por RA em 2020 x 100](Figuras/Prop_Centro-Sul_RA.png)

### Proporção de internações por CSAP, de residentes, por mês e Região Administrativa, DF, 2020
![cálculo: internações por CSAP por mês de 2020/total de internações por mês de 2020 x 100](Figuras/Prop_centro-Sul_MesRA.png)

### Proporção de internações por CSAP, de residentes, por faixa etária\* e Região Administrativa, DF, 2020
![cálculo: internações por CSAP em 2020 por faixa etária/total de internações por CSAP em 2020 x 100](Figuras/Prop_Centro-Sul_FaixaRA.png) 

### Proporção de internações por CSAP, de residentes, por sexo e Região Administrativa, DF, 2020 
![cálculo: internações por CSAP, por sexo, em 2020/total de internações por CSAP em 2020 x 100](Figuras/Prop_Centro-Sul_SexoRA.png) 

### Proporção de internações de residentes, por grupo e Região Administrativa, 2020
![cálculo: internações por grupo CSAP em 2020/total de internações por grupo CSAP em 2020 x 100](Figuras/Prop_Centro-Sul_GrupoRA.png) 
...
-----------------------------------------------------------------------
### Proporção de internações por CSAP, de residentes, Região Administrativa, DF, 2020
![cálculo: internações por CSAP por RA em 2020/total de internações por RA em 2020 x 100](Figuras/Prop_Sudoeste_RA.png)


### Proporção de internações por CSAP, de residentes, por mês e Região Administrativa, DF, 2020
![cálculo: internações por CSAP por mês de 2020/total de internações por mês de 2020 x 100](Figuras/Prop_Sudoeste_MesRA.png)

### Proporção de internações por CSAP, de residentes, por faixa etária\* e Região Administrativa, DF, 2020
![cálculo: internações por CSAP em 2020 por faixa etária/total de internações por CSAP em 2020 x 100](Figuras/Prop_Sudoeste_FaixaRA.png) 

### Proporção de internações por CSAP, de residentes, por sexo e Região Administrativa, DF, 2020 
![cálculo: internações por CSAP, por sexo, em 2020/total de internações por CSAP em 2020 x 100](Figuras/Prop_Sudoeste_SexoRA.png) 

### Proporção de internações de residentes, por grupo e Região Administrativa, 2020
![cálculo: internações por grupo CSAP em 2020/total de internações por grupo CSAP em 2020 x 100](Figuras/Prop_Sudoeste_GrupoRA.png) 
